...
public class ImageReplacedElementFactory implements ReplacedElementFactory {
    ...
    /** Logger. */
    private static Log log = LogFactory.getLog(ImageReplacedElementFactory.class.getName());

    private final ReplacedElementFactory superFactory;
    private final String resourcePath;

    public ImageReplacedElementFactory(ReplacedElementFactory superFactory, String resourcePath) {
